        ...
        <div class="bg-persian-green wrapper">
            <div class="container">
                ...
                <div class="text-center my-4 py-3">
                    <a href="https://facebook.com" target="_blank" class="btn c-btn c-btn-secondary c-btn-social mr-3"><i class="fab fa-facebook-f"></i></a>
                    <a href="https://instagram.com" target="_blank" class="btn c-btn c-btn-secondary c-btn-social mr-3"><i class="fab fa-instagram"></i></a>
    ...
    <div class="page cached" data-name="page-1" data-order="2">
        <div class="wrapper">
            <div class="container">
                ...
                <div class="pt-3 px-4">
                    <a href="#page-2" class="btn c-btn c-btn-tertiary mb-3">Next<i class="fas fa-chevron-right"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="page cached" data-name="page-2" data-order="3">
        <div class="wrapper">
            <div class="container">
                ...
                <div class="pt-3 px-4">
                    <a href="#page-3" class="btn c-btn c-btn-tertiary mb-3">Next<i class="fas fa-chevron-right"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="page cached" data-name="page-3" data-order="4">
        <div class="wrapper">
            <div class="container">
                ...
                <div class="pt-3 px-4 active">
                    <button class="btn c-btn c-btn-quaternary mb-3">Get Started</button>
                </div>
            </div>
        </div>
    </div>
