<div id="cover-photo" style="background-image:url('{{ ($campaign && $campaign->hasMedia('cover_photos')) ? $campaign->getMedia('cover_photos')->last()->getFullUrl() : '' }}')">
...
<div id="deceased-photo-container">
    <div id="deceased-photo" style="background-image:url('{{ ($campaign && $campaign->hasMedia('deceased_photos')) ? $campaign->getMedia('deceased_photos')->last()->getFullUrl() : url('img/default/deceased.png') }}')"></div>
</div>
